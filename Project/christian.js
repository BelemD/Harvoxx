...
let usersData = fs.readFile('atmData.json','utf8', (err, data) => {
...
//const usersData = JSON.parse(fs.readFileSync('/Project/atmData.json'))
...
function start() {
  ...
  var x = prompt(
    "Please enter 1 to login, dont have an account? Enter 2 to sign-up: "
  );
  switch (x) {
    case "1": {
      console.clear();
  ...
  function register() {
    ...
    while (true) {
      ...
      if (firstName == "") {
        ...
        console.log(
          "Your name cannot be a number, please enter a valid first name"
        );
      } else {
    ...
    while (true) {
      ...
      if (lastName == "") {
        ...
        console.log(
          "Your name cannot be a number, please enter a valid last name"
        );
      } else {
    ...
    while (true) {
      ...
      if (username == "") {
        ...
        console.log(
          "Your Username cannot be a number, please enter a valid username"
        );
      } else {
    ...
    function final(newUser) {
      confirm = prompt(
        "please confirm your information. press 1 to finalize or 2 to restart registeration: "
      );
      if (confirm == 1) {
...
function deposit() {
  ...
  if (user) {
    ...
    function checkAmt(amt) {
      if (isNaN(amt) == true) {
        ...
        usersData.push(
          user.transactions.push({ Type: "DEPOSIT", Amount: `+ #${amt}` })
        );
        fs.writeFileSync("dataFile.json", JSON.stringify(usersData));
  ...
  function cont() {
    var num = prompt(
      "Press 1 to make another deposit or 2 to return back to Main Menu: "
    );
    if (num == 1) {
      console.clear();
      deposit();
...
function withdraw() {
  ...
  if (user) {
    ...
    function checkBal(amt) {
      if (isNaN(amt) == true) {
        ...
        while (retry) {
          var pin = prompt(
            `You are about to make a withdrawal of ${amt}, please enter your pin to continue: `
          );
          ...
          if (checkPin && retry) {
            ...
            if (attempts <= 2) {
              console.log(
                `Incorrect Password, You will automatically be logged-out after 3 failed attempts\nYou have ${
                  3 - attempts
                } trials left`
              );
              retry = true;
  ...
  function cont() {
    var num = prompt(
      "Press 1 to make another withdrawal or 2 to return back to Main Menu: "
    );
    if (num == 1) {
      console.clear();
      withdraw();
...
function transfer() {
  ...
  if (user) {
    ...
    function checkBal(amt) {
      if (isNaN(amt)) {
        ...
        const checkInput = usersData.find(
          (checkInput) =>
            checkInput.accountNumber == input && !checkInput.isLoggedIn
        );
        if (checkInput) {
          console.log(
            `User ${checkInput.firstName} ${checkInput.lastName} found`
          );
          ...
          function checkTransferDetails() {
            ...
            console.log(
              `Recipient's Account number: ${checkInput.accountNumber}`
            );
            console.log(
              `Recipent's Name: ${checkInput.firstName} ${checkInput.lastName} `
            );
            ...
            if (finalize == 1) {
              ...
              while (retry) {
                var pin = prompt(
                  `please enter your password to complete transaction: `
                );
                if (user.password == pin) {
                  ...
                  usersData.push(
                    user.transactions.push({
                      Type: "TRANSFER",
                      Amount: `- #${amt} to ${checkInput.username}`,
                    })
                  );
                  usersData.push(
                    checkInput.transactions.push({
                      Type: "MONEY RECIEVED",
                      Amount: `+ #${amt} from ${user.username}`,
                    })
                  );
                  fs.writeFileSync("dataFile.json", JSON.stringify(usersData));
                  console.log(
                    `You Have successfully transfered #${amt} to ${checkInput.firstName} ${checkInput.lastName} `
                  );
                  cont();
                  break;
                } else {
                  ...
                  if (failure <= 2) {
                    console.log(
                      `Incorrect Password, You will be automically logged out after 3 failed attempts\nYou have ${
                        3 - failure
                      } attempts left`
                    );
                    retry = true;
  ...
  function cont() {
    var num = prompt(
      "Press 1 to make another transfer or 2 to return back to Main Menu: "
    );
    if (num == 1) {
      console.clear();
      transfer();
  ...
  if (user) {
    ...
    function select(input) {
      if (input == 1) {
        ...
        function cont() {
          var num = prompt(
            "Press 1 to make another topup or 2 to return back to Main Menu: "
          );
          if (num == 1) {
            console.clear();
            topUp();
          ...
          if ((network = 1)) {
            ...
            function checkPhoneNumber() {
              ...
              if (
                ...
                mobileNumber.includes("0", 0) &&
                mobileNumber.includes("0", 2)
              ) {
            ...
            function checkBal(amt, mobileNumber) {
              if (user.accountBal < amt) {
                ...
                usersData.push(
                  user.transactions.push({
                    Type: "AIRTIME TOPUP",
                    Amount: `- #${amt} to ${mobileNumber}`,
                  })
                );
                fs.writeFileSync("dataFile.json", JSON.stringify(usersData));
                console.log(
                  `Recharge amount of #${amt} to ${mobileNumber} Successful `
                );
                cont();
              }
            }
              ...
              if (
                ...
                switch (dataPlan) {
                  case "1": {
                    console.clear();
                    console.log(
                      "You Want To Activate 200MB for 3 days at #200"
                    );
                  ...
                  case "4": {
                    console.clear();
                    console.log(
                      "You Want To Activate 1.5GB for 30 days at #1000"
                    );
                    let shouldRestart = true;
                    while (shouldRestart) {
                      proceed = prompt(
                  ...
                  case "5": {
                    console.clear();
                    console.log(
                      "You Want To Activate 2.5GB for 2 days at #500"
                    );
                    let shouldRestart = true;
                    while (shouldRestart) {
                      proceed = prompt(
                  ...
                  case "6": {
                    console.clear();
                    console.log(
                      "You Want To Activate 10GB for 30 days at #3000"
                    );
                    let shouldRestart = true;
                    while (shouldRestart) {
                      proceed = prompt(
                  ...
                  case "7": {
                    console.clear();
                    console.log(
                      "You Want To Activate 120GB for 60 days at #20000"
                    );
                    let shouldRestart = true;
                    while (shouldRestart) {
                      proceed = prompt(
              ...
              if (
                ...
                switch (dataPlan) {
                  case "1": {
                    console.clear();
                    console.log(
                      "You Want To Activate 200MB for 2 days at #200"
                    );
                    let shouldRestart = true;
                    while (shouldRestart) {
                      proceed = prompt(
